...
### 🛡️ Portfolio Repository Showcase

* 🌐 [**osint-threat-intel-lab**](https://github.com/atta1339/osint-threat-intel-lab) — External attack surface mapping, Certificate Transparency parsing (CRT.sh), and VirusTotal API integration.
* 🦈 [**network-threat-hunting-lab**](https://github.com/atta1339/network-threat-hunting-lab) — Deep packet dissection (PyShark/Scapy) for SMB named pipes (`\svcctl`), PsExec lateral movement, and C2 tracking.
...
* **Languages:** Python 3, Splunk SPL, YARA, Snort/Suricata rules, SQL (Athena), Bash, PowerShell
* **Telemetry & Tools:** Sysmon, Wireshark, PyShark, Scapy, Splunk, AWS CloudTrail, Burp Suite, Git
* **Frameworks:** MITRE ATT&CK, NIST SP 800-61, Essential 8, ISM

---

📫 **Connect with me:** [LinkedIn](https://www.linkedin.com/in/your-profile) | 📄 **Portfolio:** 5 Interactive Security Labs
